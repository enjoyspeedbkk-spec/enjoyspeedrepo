...
update public.time_slots_config set label_th = 'ปั่นรับอรุณ' where id = 'A1';
update public.time_slots_config set label_th = 'เครื่องเสริมพลังงาน' where id = 'A2';
update public.time_slots_config set label_th = 'ไล่แสง' where id = 'B';
update public.time_slots_config set label_th = 'โกลเด้นฮาวร์' where id = 'C';
update public.time_slots_config set label_th = 'ทไวไลท์ฟินิช' where id = 'D';
